...
public class InboxUserAdapter extends RecyclerView.Adapter<InboxDoctorUserViewHolder> {
    Context context;
    List<User> userList;

    public InboxUserAdapter(Context context, List<User> userList) {
...
//        holder.specialization.setText(user.getProfession());
    ...
    private void showBottomSheet(Context context, User user) {
        ...
        specialization.setText(user.getProfession());
        if (!user.getProfileImage().equals("")) {
